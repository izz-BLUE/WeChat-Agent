...
export const config = {
  ...
  requesterLocalMaxEntries: positiveInteger('GROUP_REQUESTER_LOCAL_MAX_ENTRIES', 50),
  requesterLocalTtlMs: positiveInteger('GROUP_REQUESTER_LOCAL_TTL_MINUTES', 30) * 60_000,
  requesterLocalMaxChars: positiveInteger('GROUP_REQUESTER_LOCAL_MAX_CHARS', 8_000),
  topicCapsuleEnabled: (process.env.GROUP_TOPIC_CAPSULE_ENABLED ?? '1').trim() !== '0',
  topicCapsuleTriggerEventCount: positiveInteger('GROUP_TOPIC_CAPSULE_TRIGGER_EVENT_COUNT', 8),
  topicCapsuleTriggerCharCount: positiveInteger('GROUP_TOPIC_CAPSULE_TRIGGER_CHAR_COUNT', 1_200),
  topicCapsuleMaxPerGroup: positiveInteger('GROUP_TOPIC_CAPSULE_MAX_PER_GROUP', 8),
  topicCapsuleTtlMs: positiveInteger('GROUP_TOPIC_CAPSULE_TTL_HOURS', 24) * 60 * 60 * 1000,
  topicCapsuleMaxSelected: positiveInteger('GROUP_TOPIC_CAPSULE_MAX_SELECTED', 3),
  topicCapsuleSummaryMaxChars: positiveInteger('GROUP_TOPIC_CAPSULE_SUMMARY_MAX_CHARS', 800),
  topicCapsuleMaxChars: positiveInteger('GROUP_TOPIC_CAPSULE_MAX_CHARS', 2_400),
  topicCapsuleRecentRawEntries: positiveInteger('GROUP_TOPIC_CAPSULE_RECENT_RAW_ENTRIES', 8),
  topicCapsuleRecentRawChars: positiveInteger('GROUP_TOPIC_CAPSULE_RECENT_RAW_CHARS', 2_000),
  topicCapsuleCompactionTimeoutMs: positiveInteger('GROUP_TOPIC_CAPSULE_COMPACTION_TIMEOUT_MS', 3_000),
